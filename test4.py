...
def main(resultDict, modelKey):
    ...
    dataFolder = 'datasets\\1Var_RandSupport_FixedLength_-3to3_-5.0to-3.0-3.0to5.0_30Points'
    dataTestFolder = 'datasets\\1Var_RandSupport_FixedLength_-3to3_-5.0to-3.0-3.0to5.0_30Points'
