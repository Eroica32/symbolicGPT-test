...
def main(resultDict, modelKey):
    ...
    dataFolder = 'datasets\\2Var_RandSupport_FixedLength_-3to3_-5.0to-3.0-3.0to5.0_200Points'
    dataTestFolder = 'datasets\\2Var_RandSupport_FixedLength_-3to3_-5.0to-3.0-3.0to5.0_200Points'
    ...
    # load the test data
    path = '{}/{}/Test/*.json'.format(dataDir,dataTestFolder) #TODO changed to add the test folder
    files = glob.glob(path)
